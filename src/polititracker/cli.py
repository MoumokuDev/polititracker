"""Ingestion CLI.
    ...
    python -m polititracker.cli ingest-crec [--start YYYY-MM-DD] [--end YYYY-MM-DD]
    python -m polititracker.cli ingest-house-votes [--congress N] [--session N] [--limit N]
    python -m polititracker.cli ingest-senate-votes [--congress N] [--session N] [--limit N]
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="polititracker")
